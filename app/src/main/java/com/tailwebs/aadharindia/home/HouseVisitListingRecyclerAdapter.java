...
public class HouseVisitListingRecyclerAdapter extends HFRecyclerView<HouseVisitTaskModel> {

    String placeName;

    public HouseVisitListingRecyclerAdapter() {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final HouseVisitTaskModel item) {
