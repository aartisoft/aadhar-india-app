...
public class GroupCreationListingRecyclerAdapter extends HFRecyclerView<CreateGroupTaskModel> {

    String placeName;

    public GroupCreationListingRecyclerAdapter() {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final CreateGroupTaskModel item) {
