...
import com.tailwebs.aadharindia.home.CustomTaskDetailsActivity;
...
public class TaskListingRecyclerAdapter extends HFRecyclerView<TaskModel> {

    String placeName;

    public TaskListingRecyclerAdapter() {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final TaskModel item) {

            nameTv.setText(item.getTask_type().getName());
            ...
            dateTv.setText(item.getCreated_at_in_format());
            userLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(item.getTask_type().getCode().equalsIgnoreCase("create_group")){
                        ...
                        GlobalValue.placeName = item.getCity().getLong_name();
                        GlobalValue.placeAddress = item.getCity().getLong_name();
                        Intent intent = new Intent(TaskDashboardActivity.getInstance(),CreateGroupTaskDetailsActivity.class);
                    ...
                    } else if(item.getTask_type().getCode().equalsIgnoreCase("house_visit")){
                        GlobalValue.selectedCenter = false;
                        GlobalValue.chooseCenterFromList=false;
                        GlobalValue.isGroupPresent = false;
                        GlobalValue.placeId = item.getCity().getGoogle_place_id();
                        GlobalValue.placeName = item.getCity().getLong_name();
                        GlobalValue.placeAddress = item.getCity().getLong_name();
                        Intent intent = new Intent(TaskDashboardActivity.getInstance(),HouseVisitTaskDetailsActivity.class);
                        Bundle bundle = new Bundle();
                        GlobalValue.taskId = item.getId();
                        bundle.putString("task_id",item.getId());
                        intent.putExtras(bundle);
                    ...
                    }else if(item.getTask_type().getCode().equalsIgnoreCase("post_approval")){
                        GlobalValue.selectedCenter = false;
                        GlobalValue.chooseCenterFromList=false;
                        GlobalValue.isGroupPresent = false;
                        GlobalValue.placeId = item.getCity().getGoogle_place_id();
                        GlobalValue.placeAddress = item.getCity().getLong_name();
                        GlobalValue.placeName = item.getCity().getLong_name();
                        GlobalValue.groupId =  item.getGroupModel().getId();
                        ...
                        intent.putExtras(bundle);
                        TaskDashboardActivity.getInstance().startActivity(intent);
                    }else if(item.getTask_type().getCode().equalsIgnoreCase("collection")){
                        GlobalValue.selectedCenter = false;
                        GlobalValue.chooseCenterFromList=false;
                        GlobalValue.isGroupPresent = false;
                        GlobalValue.placeId = item.getCity().getGoogle_place_id();
                        ...
                        intent.putExtras(bundle);
                        TaskDashboardActivity.getInstance().startActivity(intent);
                    }else if(item.getTask_type().getCode().equalsIgnoreCase("custom")){
                        Intent intent = new Intent(TaskDashboardActivity.getInstance(),CustomTaskDetailsActivity.class);
                        Bundle bundle = new Bundle();
                        GlobalValue.taskId = item.getId();
                        bundle.putString("task_id",item.getId());
                        intent.putExtras(bundle);
