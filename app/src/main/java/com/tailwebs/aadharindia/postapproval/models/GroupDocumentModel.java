...
import com.tailwebs.aadharindia.postapproval.models.PostApprovalDocumentModel;
...
public class GroupDocumentModel {
    ...
    @SerializedName("group_post_approval_document")
    @Expose
    private GroupPostApprovalDocumentModel postApprovalDocumentModel;
    ...
    public GroupPostApprovalDocumentModel getPostApprovalDocumentModel() {
        return postApprovalDocumentModel;
    }

    public void setPostApprovalDocumentModel(GroupPostApprovalDocumentModel postApprovalDocumentModel) {
