...
public class CoApplicantSignatureActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyStoragePermissions(CoApplicantSignatureActivity.this);
        setContentView(R.layout.activity_post_approval_signature);
        ButterKnife.bind(this);

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        mFirebaseAnalytics.setCurrentScreen(this,  "Co-Applicant Signature Pad", null);
...
//                    Toast.makeText(SignaturePadActivity.this, "Signature saved into the Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(CoApplicantSignatureActivity.this, "Unable to store the signature", Toast.LENGTH_SHORT).show();
                }
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length <= 0
                    ...
                    Toast.makeText(CoApplicantSignatureActivity.this, "Cannot write images to external storage", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void scanMediaFile(File photo) {
        ...
        CoApplicantSignatureActivity.this.sendBroadcast(mediaScanIntent);

    }

    private void goToSignatureConfirmationPage() {

        Intent intent = new Intent(CoApplicantSignatureActivity.this,CoApplicantSignatureConfirmationActivity.class);
        finish();
