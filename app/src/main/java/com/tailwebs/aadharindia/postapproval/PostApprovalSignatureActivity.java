...
import com.tailwebs.aadharindia.housevisit.SignaturePadActivity;
...
public class PostApprovalSignatureActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyStoragePermissions(PostApprovalSignatureActivity.this);
        setContentView(R.layout.activity_post_approval_signature);
        ButterKnife.bind(this);

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        mFirebaseAnalytics.setCurrentScreen(this,  "PA Signature Pad", null);
...
//                    Toast.makeText(SignaturePadActivity.this, "Signature saved into the Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(PostApprovalSignatureActivity.this, "Unable to store the signature", Toast.LENGTH_SHORT).show();
                }
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length <= 0
                    ...
                    Toast.makeText(PostApprovalSignatureActivity.this, "Cannot write images to external storage", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void scanMediaFile(File photo) {
        ...
        PostApprovalSignatureActivity.this.sendBroadcast(mediaScanIntent);

    }

    private void goToSignatureConfirmationPage() {

        Intent intent = new Intent(PostApprovalSignatureActivity.this,PostApprovalSignatureConfirmationActivity.class);
