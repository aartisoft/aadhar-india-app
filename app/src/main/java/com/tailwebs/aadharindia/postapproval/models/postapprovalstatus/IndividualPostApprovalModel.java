...
import com.tailwebs.aadharindia.postapproval.models.groupstatus.GStatusResponseModel;
import com.tailwebs.aadharindia.member.models.CustomerModel;
import com.tailwebs.aadharindia.models.ProfileImages;

public class IndividualPostApprovalModel {
    ...
    @Expose
    private IPAStatusResponseModel ipaStatusResponseModel;
    ...
    public IPAStatusResponseModel getIpaStatusResponseModel() {
        return ipaStatusResponseModel;
    }

    public void setIpaStatusResponseModel(IPAStatusResponseModel ipaStatusResponseModel) {
        this.ipaStatusResponseModel = ipaStatusResponseModel;
    }
}
