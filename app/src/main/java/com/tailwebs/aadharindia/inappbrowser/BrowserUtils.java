...
public class BrowserUtils {
    ...
    public static void bookmarkUrl(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("drools_bookmark", 0); // 0 - for private mode
    ...
    public static boolean isBookmarked(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("drools_bookmark", 0);
