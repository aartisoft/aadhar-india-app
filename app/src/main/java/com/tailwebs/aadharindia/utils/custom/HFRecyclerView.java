package com.tailwebs.aadharindia.utils.custom;
...
public abstract class HFRecyclerView<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setData(List<T> data, boolean isTotalPenaltyPresent) {
        this.data = data;
        notifyDataSetChanged();
        this.isTotalPenaltyPresent = isTotalPenaltyPresent;
    }
    ...
    protected boolean getPenaltyPresent() { return isTotalPenaltyPresent; }
