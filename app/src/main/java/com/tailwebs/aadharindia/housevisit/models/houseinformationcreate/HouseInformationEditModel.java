...
public class HouseInformationEditModel {
    ...
    @Expose
    private ArrayList<GetSocialParametersModel> socialParametersModelArrayList;
    ...
    @Expose
    private PDFFiles signature_images;
    ...
    public ArrayList<GetSocialParametersModel> getSocialParametersModelArrayList() {
        return socialParametersModelArrayList;
    }

    public void setSocialParametersModelArrayList(ArrayList<GetSocialParametersModel> socialParametersModelArrayList) {
    ...
    public PDFFiles getSignature_images() {
        return signature_images;
    }

    public void setSignature_images(PDFFiles signature_images) {
        this.signature_images = signature_images;
    }
}
