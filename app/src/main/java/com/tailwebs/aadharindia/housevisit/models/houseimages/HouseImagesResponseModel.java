...
public class HouseImagesResponseModel {
    ...
    @Expose
    private HouseImagesModel houseImagesModel;
    ...
    public HouseImagesModel getHouseImagesModel() {
        return houseImagesModel;
    }

    public void setHouseImagesModel(HouseImagesModel houseImagesModel) {
        this.houseImagesModel = houseImagesModel;
    }
}
