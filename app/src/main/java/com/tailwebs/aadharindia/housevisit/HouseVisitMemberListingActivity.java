...
public class HouseVisitMemberListingActivity extends BaseActivity implements View.OnClickListener {
    ...
    static HouseVisitMemberListingActivity instance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_house_visit_member_listing);
        ButterKnife.bind(this);
        instance=this;

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        mFirebaseAnalytics.setCurrentScreen(this,  "HV Members", null);

        //action bar
        backButton.setOnClickListener(this);
        headingTV.setText("House Visit Members");
    ...
    public static HouseVisitMemberListingActivity getInstance() {
        return instance;
    }
    ...
    public void init(){
        ...
        if (NetworkUtils.haveNetworkConnection(this)) {
            showProgressDialog(HouseVisitMemberListingActivity.this);
            getGroupMembers();
        } else {
        ...
        try {
            ...
            call.enqueue(new Callback<GroupMemberListingResponseModel>() {
                ...
                public void onResponse(Call<GroupMemberListingResponseModel> call, final Response<GroupMemberListingResponseModel> response) {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body().getSuccess()) {
                            ...
                            NetworkUtils.handleErrorsForAPICalls(HouseVisitMemberListingActivity.this, response.body().getErrors(), response.body().getNotice());
                        }
                    } else {
                        NetworkUtils.handleErrorsCasesForAPICalls(HouseVisitMemberListingActivity.this, response.code(), response.body().getErrors());
                    }
                }
                ...
                public void onFailure(Call<GroupMemberListingResponseModel> call, Throwable t) {
                    ...
                    NetworkUtils.handleErrorsForAPICalls(HouseVisitMemberListingActivity.this, null, null);
                }
            });
    ...
    private void loadListView(GroupMemberListingResponseModel body) {
        ...
        try {
            ...
            if (jsonObject.getJSONObject("group").has("loan_takers")) {
                ...
                // Add Adapter
                HouseVisitListingRecyclerAdapter adapter = new HouseVisitListingRecyclerAdapter(GlobalValue.placeName);
                ...
                memberListingRecyclerView.addItemDecoration(new MyApplicantDividerItemDecoration(HouseVisitMemberListingActivity.this, DividerItemDecoration.VERTICAL, 16));
