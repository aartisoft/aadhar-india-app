...
import com.tailwebs.aadharindia.member.coapplicant.models.CoAStatusResponseModel;
import com.tailwebs.aadharindia.member.models.CustomerModel;
import com.tailwebs.aadharindia.models.ProfileImages;

public class HouseVisitStatusModel {
    ...
    @Expose
    private HVStatusResponseModel hvStatusResponseModel;
    ...
    public HVStatusResponseModel getHvStatusResponseModel() {
        return hvStatusResponseModel;
    }

    public void setHvStatusResponseModel(HVStatusResponseModel hvStatusResponseModel) {
        this.hvStatusResponseModel = hvStatusResponseModel;
    }
}
