...
public class UpcomingListAdapter extends BaseAdapter {
    ...
    private ArrayList<UpcomingEventsModel> arrayList;
    ...
    public UpcomingListAdapter(Context context, ArrayList<UpcomingEventsModel> arrayList, boolean isListView) {
...
//        viewHolder.checkBox.setChecked(mSelectedItemsIds.get(i));
        ...
        if(arrayList.get(i).getChecked() == true){
            ...
            public void onClick(View v) {
                ...
                if(arrayList.get(i).getCode().equalsIgnoreCase("none")){
                    ...
                    if(viewHolder.checkBox.isChecked()){
                        viewHolder.noteLayout.setVisibility(View.VISIBLE);
                        PersonalInformationActivity.getInstance().updateUpcomingListviewsize();
                    }else{
                        viewHolder.noteLayout.setVisibility(View.GONE);
                        PersonalInformationActivity.getInstance().updateUpcomingListviewsize();
                    }
...
//    }
     ...
     **/
    public ArrayList<UpcomingEventsModel> getSelectedIds() {
        return arrayList;
    }
