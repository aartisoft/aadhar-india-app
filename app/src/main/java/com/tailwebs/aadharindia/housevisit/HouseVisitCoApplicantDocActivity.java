...
import com.tailwebs.aadharindia.member.coapplicant.CoApplicantDocumentsActivity;
...
public class HouseVisitCoApplicantDocActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_house_visit_co_applicant_doc);
        ...
        mFirebaseAnalytics.setCurrentScreen(this,  "HV Co-Applicant Docs", null);

        cacdSecondaryIDModels =GlobalValue.applicantSecondaryIDArrayList;
//        secondaryDocumentSpinnerAdapter = new SecondaryDocumentSpinnerAdapter(HouseVisitCoApplicantDocActivity.this, R.layout.spinner_item,cacdSecondaryIDModels);
...
//        set secondary id
    ...
    private void setLoanReasonSpinner(ArrayList<CACDSecondaryIDModel> applicantLoanReasonArrayListNew) {
        ...
        secondaryIDSpinnerAdapter = new SecondaryIDSpinnerAdapter(HouseVisitCoApplicantDocActivity.this,
        ...
        if (NetworkUtils.haveNetworkConnection(this)) {
            showProgressDialog(HouseVisitCoApplicantDocActivity.this);
            getDocumentDetails();
        } else {
        ...
        try {
            ...
            call.enqueue(new Callback<LoanTakerCoApplicantDocumentResponseModel>() {
                ...
                public void onResponse(Call<LoanTakerCoApplicantDocumentResponseModel> call, final Response<LoanTakerCoApplicantDocumentResponseModel> response) {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body().getSuccess()) {
                            ...
                            NetworkUtils.handleErrorsForAPICalls(HouseVisitCoApplicantDocActivity.this, response.body().getErrors(), response.body().getNotice());
                        }
                    } else {
                        NetworkUtils.handleErrorsCasesForAPICalls(HouseVisitCoApplicantDocActivity.this, response.code(), response.body().getErrors());
                    }
                }
                ...
                public void onFailure(Call<LoanTakerCoApplicantDocumentResponseModel> call, Throwable t) {
                    ...
                    NetworkUtils.handleErrorsForAPICalls(HouseVisitCoApplicantDocActivity.this, null, null);
                }
            });
    ...
    private void setValuesFromResponse(LoanTakerCoApplicantDocumentResponseModel body) {
        ...
        if( profileImage == null){
            ...
            UiUtils.setDocumentUploadedisMissing(HouseVisitCoApplicantDocActivity.this,profilePicStatusTV);

            //mark not available
        }else if(profileImage == "true"){
            //mark available
            isValidProfilePic=false;
            UiUtils.setMarkedNotAvailable(HouseVisitCoApplicantDocActivity.this,profilePicStatusTV);
        }else if (profileImage == "false"){
            //file uploaded
            String profileImageIsCorrect =body.getLoanTakerModel().getCoApplicantDocumentModel().getProfileImages().getIs_correct();
            if(profileImageIsCorrect==null){

                UiUtils.setDocumentUploaded(HouseVisitCoApplicantDocActivity.this,profilePicStatusTV);
                isValidProfilePic=true;

            }else if(profileImageIsCorrect=="true"){

                UiUtils.setDocumentApproved(HouseVisitCoApplicantDocActivity.this,profilePicStatusTV);
                isValidProfilePic=true;

            }else if (profileImageIsCorrect =="false"){

                isValidProfilePic=false;
                UiUtils.setDocumentUploadedisRejected(HouseVisitCoApplicantDocActivity.this,profilePicStatusTV,
                        body.getLoanTakerModel().getCoApplicantDocumentModel().getProfileImages().getReject_reason());
            ...
            Picasso.with(HouseVisitCoApplicantDocActivity.this)
        ...
        if( aadhar_front == null){
            ...
            UiUtils.setDocumentUploadedisMissing(HouseVisitCoApplicantDocActivity.this,aadharCardFrontStatusTv);

            //mark not available
        }else if(aadhar_front == "true"){
            //mark available
            isValidAadharFront=false;
            UiUtils.setMarkedNotAvailable(HouseVisitCoApplicantDocActivity.this,aadharCardFrontStatusTv);
        }else if (aadhar_front == "false"){
            //file uploaded
            String aadhar_frontImageIsCorrect =body.getLoanTakerModel().getCoApplicantDocumentModel().getAadhar_front_images().getIs_correct();
            if(aadhar_frontImageIsCorrect==null){

                UiUtils.setDocumentUploaded(HouseVisitCoApplicantDocActivity.this,aadharCardFrontStatusTv);
                isValidAadharFront=true;

            }else if(aadhar_frontImageIsCorrect=="true"){

                UiUtils.setDocumentApproved(HouseVisitCoApplicantDocActivity.this,aadharCardFrontStatusTv);
                isValidAadharFront=true;

            }else if (aadhar_frontImageIsCorrect =="false"){

                isValidAadharFront=false;
                UiUtils.setDocumentUploadedisRejected(HouseVisitCoApplicantDocActivity.this,aadharCardFrontStatusTv,
                        body.getLoanTakerModel().getCoApplicantDocumentModel().getAadhar_front_images().getReject_reason());
        ...
        if( aadhar_back == null){
            ...
            UiUtils.setDocumentUploadedisMissing(HouseVisitCoApplicantDocActivity.this,aadharCardBackStatusTv);

            //mark not available
        }else if(aadhar_back == "true"){
            //mark available
            isValidAadharBack=false;
            UiUtils.setMarkedNotAvailable(HouseVisitCoApplicantDocActivity.this,aadharCardBackStatusTv);
        }else if (aadhar_back == "false"){
            //file uploaded
            String aadhar_frontImageIsCorrect =body.getLoanTakerModel().getCoApplicantDocumentModel().getAadhar_back_images().getIs_correct();
            if(aadhar_frontImageIsCorrect==null){

                UiUtils.setDocumentUploaded(HouseVisitCoApplicantDocActivity.this,aadharCardBackStatusTv);
                isValidAadharBack=true;

            }else if(aadhar_frontImageIsCorrect=="true"){

                UiUtils.setDocumentApproved(HouseVisitCoApplicantDocActivity.this,aadharCardBackStatusTv);
                isValidAadharBack=true;

            }else if (aadhar_frontImageIsCorrect =="false"){

                isValidAadharBack=false;
                UiUtils.setDocumentUploadedisRejected(HouseVisitCoApplicantDocActivity.this,aadharCardBackStatusTv,
                        body.getLoanTakerModel().getCoApplicantDocumentModel().getAadhar_back_images().getReject_reason());
        ...
        if( secondary_document == null){
            ...
            UiUtils.setDocumentUploadedisMissing(HouseVisitCoApplicantDocActivity.this,secondaryIdStatusTv);

            //mark not available
        }else if(secondary_document == "true"){
            //mark available
            isValidSecondaryItemSelected=false;
            UiUtils.setMarkedNotAvailable(HouseVisitCoApplicantDocActivity.this,secondaryIdStatusTv);
        }else if (secondary_document == "false"){

            secondaryDummyImage.setVisibility(View.GONE);
            secondaryGrid.setVisibility(View.VISIBLE);
            //file uploaded
            String secondary_documentImageIsCorrect =body.getLoanTakerModel().getCoApplicantDocumentModel().getSecondary_document_images_is_correct();
            if(secondary_documentImageIsCorrect==null){

                UiUtils.setDocumentUploaded(HouseVisitCoApplicantDocActivity.this,secondaryIdStatusTv);
                isValidSecondaryItemSelected=true;

            }else if(secondary_documentImageIsCorrect=="true"){

                UiUtils.setDocumentApproved(HouseVisitCoApplicantDocActivity.this,secondaryIdStatusTv);
                isValidSecondaryItemSelected=true;

            }else if (secondary_documentImageIsCorrect =="false"){

                isValidSecondaryItemSelected=false;
                UiUtils.setDocumentUploadedisRejected(HouseVisitCoApplicantDocActivity.this,secondaryIdStatusTv,
                        body.getLoanTakerModel().getCoApplicantDocumentModel().getSecondary_document_images_reject_reason());
...
//            secondaryIdET.setText(body.getLoanTakerModel().getCoApplicantDocumentModel().getSecondaryIDModel().getName());
//                secondaryIdNotAvailable.setVisibility(View.GONE);
            ...
            for(int i=0;i<body.getLoanTakerModel().getCoApplicantDocumentModel().getSecondaryDocumentImageModelArrayList().size();i++){
                Log.i("Shahana","-Sec-"+body.getLoanTakerModel().getCoApplicantDocumentModel()
                        .getSecondaryDocumentImageModelArrayList().get(i)
                        .getSecondaryDocumentImageModel().getUploadImages().getMedium());

                result_secondary.add(body.getLoanTakerModel().getCoApplicantDocumentModel()
                        .getSecondaryDocumentImageModelArrayList().get(i)
    ...
    private void editShowPopup(final String picUploadedUrl, final String value){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HouseVisitCoApplicantDocActivity.this);
        ...
        editTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(value.equalsIgnoreCase("profile_pic")){
                    ...
                    CropImage.activity(null).setGuidelines(CropImageView.Guidelines.ON).start(HouseVisitCoApplicantDocActivity.this);
        ...
        showTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(HouseVisitCoApplicantDocActivity.this,
    ...
    private void checkValidationForImages() {
        ...
        if((isValidProfilePic) &&
            ...
            params.putString("status","house_visit_co_applicant_doc_created");
            params.putString("applicant_id", GlobalValue.loanTakerIdForAnalytics);
            mFirebaseAnalytics.logEvent("house_visit_co_applicant_docs", params);
            ...
            if(!isValidProfilePic){
                UiUtils.setDocumentNotUploaded(HouseVisitCoApplicantDocActivity.this,profilePicStatusTV);

            }

            if(!isValidAadharFront){
                UiUtils.setDocumentNotUploaded(HouseVisitCoApplicantDocActivity.this,aadharCardFrontStatusTv);
            }

            if(!isValidAadharBack){
                UiUtils.setDocumentNotUploaded(HouseVisitCoApplicantDocActivity.this,aadharCardBackStatusTv);
            }

            if(!isValidSecondaryItemSelected){
                UiUtils.setDocumentNotUploaded(HouseVisitCoApplicantDocActivity.this,secondaryIdStatusTv);
            }
        }
    }

    private void goToHousePhotos() {
        startActivity(new Intent(HouseVisitCoApplicantDocActivity.this,HousePhotosActivity.class));
        finish();
    }
...
//
//
//                    Log.i("Shahana", "positionsss" + positions);
//                    List<SquareImage> deleteImages = new ArrayList<>();
//                    for (int position : positions) {
//                        Log.i("Shahana", "position" + position);
//                    }
//                }
//            }
            ...
            public void onResponse(Call<LoanTakerCoApplicantDocumentResponseModel> call, Response<LoanTakerCoApplicantDocumentResponseModel> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body().getSuccess()) {
                        ...
                        Toast.makeText(HouseVisitCoApplicantDocActivity.this, "" + response.body().getNotice(), Toast.LENGTH_SHORT).show();
    ...
    private class AsyncTaskRunnerForProfilePic extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            UiUtils.setDocumentUploading(HouseVisitCoApplicantDocActivity.this,profilePicStatusTV);
        }
    ...
    private class AsyncTaskRunnerForAadharFront extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            UiUtils.setDocumentUploading(HouseVisitCoApplicantDocActivity.this,aadharCardFrontStatusTv);
        }
    ...
    private class AsyncTaskRunnerForAadharBack extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            UiUtils.setDocumentUploading(HouseVisitCoApplicantDocActivity.this,aadharCardBackStatusTv);
        }
...
//                            Toast.makeText(HouseVisitCoApplicantDocActivity.this, "" + response.body().getNotice(), Toast.LENGTH_SHORT).show();
    ...
    private void saveMultipleSecondaryDocuments() {
        ...
        UiUtils.setDocumentUploading(HouseVisitCoApplicantDocActivity.this,secondaryIdStatusTv);
