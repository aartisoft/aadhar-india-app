...
public class PastEventsResponseListAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<PastResponseModel> arrayList;
    ...
    public PastEventsResponseListAdapter(Context context, ArrayList<PastResponseModel> arrayList, boolean isListView) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.label.setText(arrayList.get(i).getPastEventsModel().getName());
//        viewHolder.checkBox.setChecked(mSelectedItemsIds.get(i));

        Log.i("Response P","is there"+arrayList.get(i).getIs_there()+arrayList.get(i).getPastEventsModel().getName() );


        if(arrayList.get(i).getIs_there()){
            viewHolder.checkBox.setChecked(true);
            viewHolder.noteLayout.setVisibility(View.VISIBLE);
            viewHolder.noteET.setText(arrayList.get(i).getNote());
            if(arrayList.get(i).getPastEventsModel().getCode().equalsIgnoreCase("none")){
            ...
            public void onClick(View v) {
                ...
                if(arrayList.get(i).getPastEventsModel().getCode().equalsIgnoreCase("none")){
                    ...
                    if(viewHolder.checkBox.isChecked()){
                        viewHolder.noteLayout.setVisibility(View.VISIBLE);
                        PersonalInformationEditActivity.getInstance().updatePastListviewsize();
                    }else{
                        viewHolder.noteLayout.setVisibility(View.GONE);
                        PersonalInformationEditActivity.getInstance().updatePastListviewsize();
                    }
...
//        });
        ...
        viewHolder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked){
                    Log.i("Aadhar India","is checked"+arrayList.get(i).getPastEventsModel().getName());
...
//    }
     ...
     **/
    public ArrayList<PastResponseModel> getSelectedIds() {
        return arrayList;
    }
