...
import com.tailwebs.aadharindia.member.MemberScanResponseActivity;
...
public class AddNewCoApplicantScanActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       loanTakerID = GlobalValue.loanTakerId;
        ...
        headingTV.setText("Add New Co-Applicant");
        headingTV.setTextAppearance(getApplicationContext(),R.style.MyActionBarHeading);


        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        mFirebaseAnalytics.setCurrentScreen(this,  "New Co-Applicant Aadhaar Scan ", null);
...
//                Toast.makeText(this, "camera permission granted", Toast.LENGTH_LONG).show();
    ...
    private void continueButtonCall() {
        ...
        showProgressDialog(AddNewCoApplicantScanActivity.this);

        try {
            ApiInterface apiService = RetrofitClientWithHeaders.getClient().create(ApiInterface.class);
            Call<LoanTakerCoApplicantDetailsResponseModel> call = apiService.getCoApplicantByAadharNumber(loanTakerID,aadharNoET.getText().toString().trim());
...
//                            show popup
                            ...
                            goToCoApplicantDetailsPage(response.body());
                        }
                    } else {
                        NetworkUtils.handleErrorsCasesForAPICalls(AddNewCoApplicantScanActivity.this, response.code(), response.body().getErrors());
                    }
                }
                ...
                public void onFailure(Call<LoanTakerCoApplicantDetailsResponseModel> call, Throwable t) {
                    ...
                    NetworkUtils.handleErrorsForAPICalls(AddNewCoApplicantScanActivity.this, null, null);
                }
            });
    ...
    private void showDialogBox(LoanTakerCoApplicantDetailsResponseModel body) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddNewCoApplicantScanActivity.this);
    ...
    private void goToCoApplicantDetailsPage(LoanTakerCoApplicantDetailsResponseModel body) {


        Intent intent = new Intent(AddNewCoApplicantScanActivity.this,CoApplicantActivity.class);
        ...
        public void afterTextChanged(Editable editable) {
            ...
            switch (view.getId()) {
                case R.id.input_aadhar_no:
                    ...
                    boolean aadharStatus = UiUtils.checkValidation(AddNewCoApplicantScanActivity.this, aadharNoET, aadharNoLayout, itemPassed);
    ...
    public void requestFocus(View view) {
        if (view.requestFocus())
            AddNewCoApplicantScanActivity.this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
    }
