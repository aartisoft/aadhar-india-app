 ...
 */
public class PrimaryJobFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_primary_job, container, false);
        ButterKnife.bind(this,view);

        if (NetworkUtils.haveNetworkConnection(getActivity())) {
            showProgressDialog(getActivity());
            Bundle bundle = this.getArguments();
            getPrimaryJobs(bundle.getString("code"));
        } else {
    ...
    private void getPrimaryJobs(String codeVal) {

        try {

            ApiInterface apiService = RetrofitClientWithHeaders.getClient().create(ApiInterface.class);
            Call<PrimaryJobResponseModel> call = apiService.getPrimaryJobs(codeVal);
...
//    @Override
//    public void onJobSelected(PrimaryJobModel languageModel) {
//
//        if(!languageModel.getIs_leaf()){
//            if (NetworkUtils.haveNetworkConnection(getActivity())) {
//                showProgressDialog(getActivity());
//                getPrimaryJobs(languageModel.getCode());
//            } else {
//                UiUtils.showAlertDialogWithOKButton(getActivity(), getString(R.string.error_no_internet), new DialogInterface.OnClickListener() {
//                    @Override
//                    public void onClick(DialogInterface dialogInterface, int i) {
...
//
////
////            Intent intent = new Intent(SelectPrimaryJobActivity.this, SelectPrimaryJobActivity.class);
////            intent.putExtra("code",languageModel.getCode());
...
//            Toast.makeText(getActivity(), ""+languageModel.getName(), Toast.LENGTH_SHORT).show();
//        }
