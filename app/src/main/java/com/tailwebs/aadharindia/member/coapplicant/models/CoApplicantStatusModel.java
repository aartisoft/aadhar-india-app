...
import com.tailwebs.aadharindia.member.models.applicantstatus.ApplicantStatusModel;
import com.tailwebs.aadharindia.models.ProfileImages;

public class CoApplicantStatusModel {
    ...
    @Expose
    private CoAStatusResponseModel applicantStatusModel;
    ...
    public CoAStatusResponseModel getApplicantStatusModel() {
        return applicantStatusModel;
    }

    public void setApplicantStatusModel(CoAStatusResponseModel applicantStatusModel) {
        this.applicantStatusModel = applicantStatusModel;
    }
}
