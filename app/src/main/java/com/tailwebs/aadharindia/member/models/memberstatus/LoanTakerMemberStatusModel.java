...
public class LoanTakerMemberStatusModel {
    ...
    public MemberStatusModel getMemberStatusModel() {
        return memberStatusModel;
    }

    public void setMemberStatusModel(MemberStatusModel memberStatusModel) {
        this.memberStatusModel = memberStatusModel;
    }
}
