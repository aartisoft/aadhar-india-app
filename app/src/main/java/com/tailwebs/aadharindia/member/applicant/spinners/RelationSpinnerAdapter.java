...
public class RelationSpinnerAdapter extends ArrayAdapter<CACDLoanTakerRelationsModel> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private CACDLoanTakerRelationsModel[] values;
    LayoutInflater inflator;

    public RelationSpinnerAdapter(Context context, int textViewResourceId,
                       CACDLoanTakerRelationsModel[] values) {
    ...
    @Override
    public CACDLoanTakerRelationsModel getItem(int position){
