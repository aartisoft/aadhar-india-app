...
public class SelectGroupLeaderAdapter extends RecyclerView.Adapter<SelectGroupLeaderAdapter.MyViewHolder>
...
//                    listener.onLanguageSelected(contactListFiltered.get(getAdapterPosition()));
//                }
//            });
        }
    }
    ...
    public SelectGroupLeaderAdapter(Context context, List<LanguageModel> contactList, LanguageAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_group_member_select_leader, parent, false);
