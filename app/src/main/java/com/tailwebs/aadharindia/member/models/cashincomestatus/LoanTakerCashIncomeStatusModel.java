...
public class LoanTakerCashIncomeStatusModel {
    ...
    @Expose
    private CashIncomeModel cashIncomeModel;
    ...
    public CashIncomeModel getCashIncomeModel() {
        return cashIncomeModel;
    }

    public void setCashIncomeModel(CashIncomeModel cashIncomeModel) {
        this.cashIncomeModel = cashIncomeModel;
    }
}
