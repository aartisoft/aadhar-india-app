...
//1.Inside searchinmap
//2.inside center
//3.inside home
//4.inside member applicant(2)
//5.inside member coapplicant(2)


public class AlternateAutoCompleteAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {

    private ArrayList<AutocompletePrediction> mResultList;
    private PlacesClient placesClient;

    AlternateAutoCompleteAdapter(Context context, PlacesClient placesClient) {
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        ...
        RectangularBounds bounds = RectangularBounds.newInstance(
                new LatLng(53.801277, -1.548567),
                new LatLng(53.841277, -1.508567));
