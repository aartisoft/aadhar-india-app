...
public class LoanTakerApplicantDocumentDetailsModel {
    ...
    @Expose
    private ApplicantDocumentModel applicantDocumentModel;
    ...
    public ApplicantDocumentModel getApplicantDocumentModel() {
        return applicantDocumentModel;
    }

    public void setApplicantDocumentModel(ApplicantDocumentModel applicantDocumentModel) {
