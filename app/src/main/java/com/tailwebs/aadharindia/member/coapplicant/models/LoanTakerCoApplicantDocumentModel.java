...
public class LoanTakerCoApplicantDocumentModel {
    ...
    @Expose
    private CoApplicantDocumentModel coApplicantDocumentModel;
    ...
    public CoApplicantDocumentModel getCoApplicantDocumentModel() {
        return coApplicantDocumentModel;
    }

    public void setCoApplicantDocumentModel(CoApplicantDocumentModel coApplicantDocumentModel) {
