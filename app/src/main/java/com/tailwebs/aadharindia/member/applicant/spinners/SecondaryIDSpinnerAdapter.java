...
public class SecondaryIDSpinnerAdapter extends ArrayAdapter<CACDSecondaryIDModel> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private CACDSecondaryIDModel[] values;
    LayoutInflater inflator;

    public SecondaryIDSpinnerAdapter(Context context, int textViewResourceId,
                                     CACDSecondaryIDModel[] values) {
    ...
    @Override
    public CACDSecondaryIDModel getItem(int position){
