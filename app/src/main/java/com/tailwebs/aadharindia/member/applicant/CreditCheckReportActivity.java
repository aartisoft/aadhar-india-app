...
public class CreditCheckReportActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseAnalytics.setCurrentScreen(this, "Credit Check Report", null);
        ...
        if (NetworkUtils.haveNetworkConnection(this)) {
            showProgressDialog(CreditCheckReportActivity.this);
        ...
        try {
            ...
            call.enqueue(new Callback<LoanTakerCreditCheckReportResponseModel>() {
                ...
                public void onResponse(Call<LoanTakerCreditCheckReportResponseModel> call, final Response<LoanTakerCreditCheckReportResponseModel> response) {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body().getSuccess()) {
                            ...
                            NetworkUtils.handleErrorsForAPICalls(CreditCheckReportActivity.this, response.body().getErrors(), response.body().getNotice());
                        }
                    } else {
                        NetworkUtils.handleErrorsCasesForAPICalls(CreditCheckReportActivity.this, response.code(), response.body().getErrors());
                    }
                }
                ...
                public void onFailure(Call<LoanTakerCreditCheckReportResponseModel> call, Throwable t) {
                    ...
                    NetworkUtils.handleErrorsForAPICalls(CreditCheckReportActivity.this, null, null);
                }
            });
...
//        setStatusForTheFields(creditScoreET,body.getLoanTakerCreditCheckReportModel().getCreditCheckReportModel().getCcrReportModel().getCreditScoreModel().getIs_satisfied());
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(CreditCheckReportActivity.this);
            ...
            noButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    params.putString("status","applicant_cc_report_created");
                    mFirebaseAnalytics.logEvent("applicant_credit_check_report", params);
...
//            String loanTakerId =GlobalValue.loanTakerId;
    ...
    private void goToMemberListingPage() {
        Intent intent = new Intent(CreditCheckReportActivity.this,GroupMemberListingActivity.class);
    ...
    private void goToEMICalculatorPage() {
       ...
       Intent emiIntent = new Intent(CreditCheckReportActivity.this,EMICalculatorActivity.class);
