...
public class LoanTakerApplicantStatusModel {
    ...
    @Expose
    private ApplicantStatusModel applicantStatusModel;
    ...
    public ApplicantStatusModel getApplicantStatusModel() {
        return applicantStatusModel;
    }

    public void setApplicantStatusModel(ApplicantStatusModel applicantStatusModel) {
